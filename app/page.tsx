    ...
    return (
        <>
            <header className=" bg-purple-950 py-5">
                <div className="max-w-3xl mx-auto flex flex-col lg:flex-row items-center">
                    ...
                    <nav className="flex flex-col lg:flex-row lg:justify-end gap-5 w-full ">
                        <Link
                            href='/auth/login'
                            className="font-bold text-white  hover:text-amber-500 uppercase text-sm text-center dark:text-slate-200"
                        >Iniciar Sesión</Link>
                        <Link
                            href='/auth/register'
                            className="font-bold text-white hover:text-amber-500 uppercase text-sm text-center dark:text-slate-200"
            ...
            <main className=" max-w-3xl mx-auto p-5 space-y-5 mt-20">
                <h1 className="font-black text-4xl lg:text-6xl text-purple-950 dark:text-purple-600">Administrador de Gastos</h1>
                ...
                <h2 className="font-black text-4xl text-purple-950 dark:text-purple-600">Ventajas de CashTrackr</h2>

                <ol className="grid grid-cols-1 gap-5 items-start">
                    <div className="dark:bg-slate-800 shadow-lg rounded-md">
                        <li className="p-5 text-lg ">
                            <span className="text-purple-950 dark:text-purple-600 font-black">Organización sin Esfuerzo: </span>
                            Clasifica y visualiza tus gastos de forma clara y ordenada, sin complicaciones con nuestro panel amigable y fácil de usar.
                        </li>
                    </div>
                    <div className="dark:bg-slate-800 shadow-lg rounded-md">
                        <li className="p-5 shadow-lg text-lg rounded-md">
                            <span className="text-purple-950 dark:text-purple-600 font-black">Presupuestación Inteligente: </span>
                            Establece objetivos financieros realistas y sigue tu progreso con nuestras herramientas de presupuestación inteligente.
                        </li>
                    </div>
                    <div className="dark:bg-slate-800 shadow-lg rounded-md">
                        <li className="p-5 shadow-lg text-lg rounded-md">
                            <span className="text-purple-950 dark:text-purple-600 font-black">Acceso en cualquier lugar: </span>
                            Nuestra plataforma está disponible para que puedas gestionar tus finanzas desde donde te encuentres.
                        </li>
                    </div>
                    <div className="dark:bg-slate-800 shadow-lg rounded-md">
                        <li className="p-5 shadow-lg text-lg rounded-md">
                            <span className="text-purple-950 dark:text-purple-600 font-black">Seguridad Garantizada: </span>
            ...
            <nav className="flex flex-col lg:flex-row lg:justify-between gap-5 mt-10 pb-20 max-w-3xl mx-auto ">
                <Link
                    href="/auth/register"
                    className="text-gray-500 dark:text-slate-300 text-sm uppercase text-center"
