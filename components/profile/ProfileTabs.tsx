        ...
        <div className='mb-5'>
            <div className="sm:hidden">
                ...
                <select
                    id="tabs"
                    name="tabs"
                    className="block w-full rounded-md border-gray-300 dark:bg-slate-800 focus:border-purple-800 dark:focus:border-purple-600 focus:ring-purple-800 dark:focus:ring-purple-600"
                    ...
                    <nav className="-mb-px flex space-x-8" aria-label="Tabs">
                        {tabs.map((tab) => (
                            ...
                            >
                                <tab.icon
                                    className={classNames(
                                        pathname === tab.href ? 'text-purple-800 dark:text-purple-600' : 'text-gray-400 group-hover:text-gray-500',
                                        '-ml-0.5 mr-2 h-5 w-5'
                                    )}
                                    aria-hidden="true"
                                />
