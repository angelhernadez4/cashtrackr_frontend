                ...
                <Dialog as="div" className="relative z-10" onClose={() => router.replace(`${pathname}?${hideModal}`)}>
                    ...
                    <div className="fixed inset-0 overflow-y-auto">
                        <div className="flex min-h-full items-center justify-center p-4 text-center">
                            ...
                            >
                                <DialogPanel className="w-full max-w-5xl transform overflow-hidden rounded-2xl bg-white dark:bg-slate-900 text-left align-middle shadow-xl transition-all p-16">
                                    <ConfirmPasswordForm />
                                </DialogPanel>
                            </TransitionChild>
                        </div>
